...
public interface IValuer : IEqualityComparer<object>, IEqualityComparer
{
    ...
    /// <param name="optionConfiguration">Modifications for the duplicator options to use.</param>
    ...
    IEnumerable<Difference> Compare(object? expected, object? actual, Func<ValuerOptions, ValuerOptions>? optionConfiguration = null);

    /// <inheritdoc cref="Equals(object,object,Func{ValuerOptions,ValuerOptions})"/>
    ...
    /// <exception cref="NotSupportedException">If no hint supports comparing the objects.</exception>
    /// <exception cref="InsufficientExecutionStackException">If infinite recursion occurs.</exception>
    bool Equals(object? x, object? y, Func<ValuerOptions, ValuerOptions>? optionConfiguration = null);

    /// <inheritdoc cref="GetHashCode(object,Func{ValuerOptions,ValuerOptions})"/>
    ...
    /// <exception cref="InsufficientExecutionStackException">If infinite recursion occurs.</exception>
    int GetHashCode(object? item, Func<ValuerOptions, ValuerOptions>? optionConfiguration = null);
}
