...
public partial class Asserter : IComparableAsserter
{
    ...
    /// <inheritdoc/>
    public virtual void GreaterThanOrEqualTo(IComparable? target, IComparable? value, string? details = null)
    {
    ...
    /// <inheritdoc/>
    public virtual void GreaterThanOrIs(IComparable? target, IComparable? value, string? details = null)
    {
    ...
    /// <inheritdoc/>
    public virtual void LessThanOrEqualTo(IComparable? target, IComparable? value, string? details = null)
    {
    ...
    /// <inheritdoc/>
    public virtual void LessThanOrIs(IComparable? target, IComparable? value, string? details = null)
    {
    ...
    /// <inheritdoc/>
    public virtual void InRange(IComparable? min, IComparable? max, IComparable? value, string? details = null)
    {
        ...
        AsserterMod optionConfiguration, string? details = null)
    {
        ...
        if (value == null)
        {
            throw new AssertException(
                ...
                details, localOptions.Gen.InitialSeed);
        }
        else if (min == null || max == null)
        {
            throw new AssertException(
                $"Min {min} or max {max} was null and not valid for math comparison check.",
                details, localOptions.Gen.InitialSeed, value.ToString());
        }
