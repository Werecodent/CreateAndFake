...
public interface IStringAsserter
{
    ...
    void Contains(string content, string? text, AsserterMod optionConfiguration, string? details = null);
    ...
    /// <inheritdoc cref="Contains(string,string,AsserterMod,string)"/>
    void ContainsNot(string content, string? text, AsserterMod optionConfiguration, string? details = null);
    ...
    /// <inheritdoc cref="Contains(string,string,AsserterMod,string)"/>
    void StartsWith(string content, string? text, AsserterMod optionConfiguration, string? details = null);
    ...
    /// <inheritdoc cref="Contains(string,string,AsserterMod,string)"/>
    void StartsNotWith(string content, string? text, AsserterMod optionConfiguration, string? details = null);
    ...
    /// <inheritdoc cref="Contains(string,string,AsserterMod,string)"/>
    void EndsWith(string content, string? text, AsserterMod optionConfiguration, string? details = null);
    ...
    /// <inheritdoc cref="Contains(string,string,AsserterMod,string)"/>
    void EndsNotWith(string content, string? text, AsserterMod optionConfiguration, string? details = null);
}
