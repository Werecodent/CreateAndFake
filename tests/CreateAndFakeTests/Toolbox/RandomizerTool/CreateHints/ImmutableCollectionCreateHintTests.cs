...
public sealed class ImmutableCollectionCreateHintTests : CreateHintTestBase<ImmutableCollectionCreateHint>
{
    ...
    public ImmutableCollectionCreateHintTests() : base(_TestInstance, _ValidTypes, _InvalidTypes) { }
